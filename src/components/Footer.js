            ...
            <div className="container-fluid pt-5 bg-footer">
                            ...
                            <div className="footer-list-div">
                                ...
                                <ul>
                                    ...
                                    <li className="pb-3">
                                        ...
                                        <span>nikhilsanju19@gmail.com</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div className="container">
                    <div className="col-12 footer-copyright">
                        <p>© 2025 Quick Food. All Rights Reserved. Powered By <span style={{ color: "#eb6825", fontWeight: 700 }}>Nikhil N</span></p>
                    </div>
                </div>
            </div>
        );
